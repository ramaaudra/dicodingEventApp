...
import com.dicoding.eventapp.ui.ui.detail.DetailEventActivity

class HorizontalAdapter : ListAdapter<ListEventsItem, HorizontalAdapter.EventViewHolder>(DIFF_CALLBACK) {
